  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6">
      <div className="text-center">
        <h1 className="mb-4 font-display text-4xl font-bold text-foreground">A-Levels Guide</h1>
        <p className="mb-8 text-muted-foreground">Coming soon — AI-powered A-Level guidance.</p>
        <button
